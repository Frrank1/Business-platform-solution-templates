...
The Sales Management solution template for Salesforce is targeted at sales executives, managers and salespeople to forecast revenue, compare sales to the same period in the prior month, quarter or year, track sales against goals and monitor their pipeline .
...
-	Data extraction (Informatica or Scribe)
...
The sales management solution template utilizes Informatica or Scribe replication jobs. The following tables are replicated:
-	Account
-	BusinessUnit
-	Lead
-	Opportunity
