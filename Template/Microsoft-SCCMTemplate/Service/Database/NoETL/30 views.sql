...
SELECT [machineid]
      ...
      ,CASE
            ...
            when [operating system] like '%Windows%6.1%' then 'Windows 7'
            when [operating system] like '%Windows%6.2%' then 'Windows 8'
            when [operating system] like '%Windows%6.3%' OR [operating system] like '%Windows%6.4%' OR [operating system] like 'Windows 8.1%' then 'Windows 8.1'
